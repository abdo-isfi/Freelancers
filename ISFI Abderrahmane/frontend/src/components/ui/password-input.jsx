    ...
    <div className="w-full min-w-[200px] relative">
      ...
      <div className="relative w-full">
        <input
          ...
          className="peer relative z-10 w-full h-12 px-4 py-3.5 pr-12
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 z-20 
                     text-[var(--color-text-secondary)] hover:text-purple-600 dark:hover:text-purple-400
                     transition-colors duration-200
                     p-1 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/20
